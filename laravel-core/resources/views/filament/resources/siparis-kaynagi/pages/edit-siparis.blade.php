<x-filament-panels::page>
    <div class="ecommerce-web-cork-screen ecommerce-cork-screen web-cork-form-screen">
    @if (\App\Filament\Resources\SiparisKaynagi::detayModu())
        ...
        <form wire:submit="save" class="space-y-4">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">
                ...
                <select
                    ...
                    @disabled(\App\Models\Ecommerce\Siparis::iptalEdildiDurumMu($record->durum ?? null))
                >
                    @foreach ($this->durumSecenekleri() as $deger => $etiket)
