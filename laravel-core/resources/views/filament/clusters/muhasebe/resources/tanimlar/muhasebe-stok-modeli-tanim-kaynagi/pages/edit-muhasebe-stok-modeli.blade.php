        ...
        <form wire:submit="save" class="space-y-4">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">
                ...
                <input
                    ...
                    required
                    wire:model="data.kod"
                    class="mt-1 block w-full max-w-xs rounded-lg border-gray-300 shadow-sm uppercase focus:border-primary-500 focus:ring-primary-500 dark:border-white/10 dark:bg-gray-900 dark:text-gray-100"
                >
            </label>
