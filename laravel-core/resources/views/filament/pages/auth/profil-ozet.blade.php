...
<div class="yk-profile-summary overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-gray-900">
    <div class="yk-profile-summary__body p-5">
    ...
    <div class="yk-profile-summary__note border-t border-gray-100 bg-gray-50/70 px-5 py-3 text-sm text-gray-500 dark:border-white/10 dark:bg-white/[0.03] dark:text-gray-400">
        Şifre değiştirirken mevcut şifre, yeni şifre ve tekrar alanlarının tamamını doldurun.
    </div>
</div>
