@php
    ...
    // Varsayilan Filament sidebar menusu bu projede kaldirildi; custom sidebar hook'u kullaniliyor.
    // Gosterilmeyen navigation agacini her istekte uretmek admin sayfa gecislerini gereksiz yavaslatiyor.
    $navigation = filament()->hasTopNavigation() ? filament()->getNavigation() : [];
    $adminLayout = \App\Support\AdminLayoutPreference::forUser(auth()->user());
    $horizontalLayout = filament()->getId() === 'admin'
        && $adminLayout === \App\Support\AdminLayoutPreference::HORIZONTAL;
@endphp
...
<x-filament-panels::layout.base :livewire="$livewire">
    ...
    <div
        class="fi-layout flex min-h-screen w-full flex-row-reverse flex-nowrap items-stretch overflow-x-clip"
    >
        <div
            ...
            @endif
            @class([
                'fi-main-ctn w-full min-w-0 flex-1 flex-col',
