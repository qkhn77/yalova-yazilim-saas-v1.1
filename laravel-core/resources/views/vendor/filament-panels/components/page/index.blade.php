...
@php
    ...
    /*
     * Admin panelinde tek navigation kaynağı custom-sidebar'dır.
     * Filament'in page/cluster/resource sub-navigation'ı route ve yetki
     * tanımlarını koruyarak yalnızca presentation katmanında kapatılır.
     * Böylece sidebar, mobile select ve boş secondary kolon hiç render edilmez.
     */
    $subNavigation = [];
